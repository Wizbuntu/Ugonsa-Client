...
import {oldMemberRegisterValidation} from '../Util/Validations'
...
// init OldMemberRegister component 
const OldMemberRegister = () => {
    ...
    const openUploadWidget = () => {
        ...
        .openUploadWidget({
            ...
            // update uploadIDcard state
            setUploadIDCard(result[0].secure_url)
        })
    }
      ...
      const handleSubmit = () => {
        ...
        const error = oldMemberRegisterValidation(registerData)
        ...
        // axios post request to old register endpoint
        axios.post('/v1/api/register/old', registerData)
        .then(({data}) => {
            // update loading to false
            setLoading(false)
    ...
    return (
        <React.Fragment>
            ...
            <title>Old Member Register - Ugonsa</title>
                       ...
                       <div className="card rounded shadow-sm bg-white">
                           <div className="card-body">
                               <center className="m-t-30">
                                ...
                                <button onClick={() => openUploadWidget()} className="btn btn-outline-secondary btn-lg btn-block btn-large">{uploadIDCard? "Upload Successful" : "Upload ID Card"}</button>
                                <p className="mt-3">Click to upload a scanned image of your UGONSA ID Card.</p>
                                </div>
                               </center>
                           </div>
                       </div>
                               ...
                               <form className="form-horizontal form-material">
                                   ...
                                   <div className="row">
                                    ...
                                    <div className="row">
                                       ...
                                       <div className="col-md-12">
                                       <div className="form-group">
                                                   <label htmlFor="phone" className="col-md-12">Registration Number</label>
                                                   <small>Enter the last digits of your registration number. example: UGONSA/ID/NAT/0004. You will enter <b>0004</b></small>
                                                   <div className="col-md-12">
                                                       <input type="number" placeholder="Enter Registration Number e.g 0004" value={registrationNumber} onChange={handleChange('registrationNumber')} className="form-control form-control-line"/>
                                                   </div>
                                               </div>
                                       </div>
...
// export OldMemberRegister
export default OldMemberRegister